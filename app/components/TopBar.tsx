...
const TopBar = () => {
  ...
  return (
    <div className="w-full h-[4rem] fixed flex justify-between items-center top-0 left-0 z-50 px-6">
      ...
      <div className="cart-cont relative">
        ...
        <IoCartOutline className="text-white text-3xl" onClick={() => router.push('/cart')}/>
      </div>
    </div>
  );
};
